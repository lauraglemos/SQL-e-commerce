...
CREATE TABLE Recintos (
    ...
    PRIMARY KEY (UbicacionRecinto)
);

INSERT INTO Recintos (UbicacionRecinto) VALUES
...
CREATE TABLE Gradas (
    ...
    CONSTRAINT fk_divide FOREIGN KEY (UbicacionRecinto) REFERENCES Recintos(UbicacionRecinto)
); 
...
INSERT INTO Localidades (UbicacionRecinto, NombreGrada, UbicacionLocalidad, EstadoLocalidad) VALUES
    ...
    ('40.43618570541075, -3.5993493869409128', 'Pista Zona Artistas', 'Fila 3, Asiento 24', 'Libre');
...
CREATE TABLE ocurre (
    NombreEvento varchar(50) NOT NULL,
    FechaEvento date NOT NULL,
    TituloEspectaculo varchar(50) NOT NULL,
    TipoEspectaculo varchar(20) NOT NULL,
    ...
    CONSTRAINT fk_ocurre_recinto FOREIGN KEY (UbicacionRecinto) REFERENCES Recintos(UbicacionRecinto)
);
...
INSERT INTO oferta (UbicacionRecinto, NombreGrada, UbicacionLocalidad, TipoUsuario, Precio) VALUES
    ('40.43618570541075, -3.5993493869409128', 'Pista Zona Artistas', 'Fila 3, Asiento 24', 'Adulto', 164.95),
    ('40.43618570541075, -3.5993493869409128', 'Pista Zona Artistas', 'Fila 3, Asiento 24', 'Infantil', 127.35),
    ('40.43618570541075, -3.5993493869409128', 'Pista Zona Artistas', 'Fila 3, Asiento 24', 'Jubilado', 164.95),
    ('40.43618570541075, -3.5993493869409128', 'Pista Zona Artistas', 'Fila 3, Asiento 24', 'Parado', 164.95),
...
CREATE TABLE vendida (
    ...
    TipoUsuarioAsistente ENUM('Jubilado', 'Adulto', 'Infantil', 'Parado') NOT NULL,
    UbicacionRecinto varchar(50) NOT NULL,
    NombreGrada varchar(30) NOT NULL,
    UbicacionLocalidad varchar(50) NOT NULL,
    PRIMARY KEY (DNICliente, TipoUsuarioAsistente, UbicacionRecinto, NombreGrada, UbicacionLocalidad),
    CONSTRAINT fk_vendida_cliente FOREIGN KEY (DNICliente) REFERENCES Cliente(DNI),
    CONSTRAINT fk_vendida_usuario FOREIGN KEY (TipoUsuarioAsistente) REFERENCES Usuarios(Tipo),
